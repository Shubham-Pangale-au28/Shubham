...
class App extends Component {
  ...
  render() {
    ...
    var endDate = this.state.endDate ? "Arrive: "+this.state.endDate.toString().slice(4, 15) : "";
        ...
        <div className="container">
          <div className="one-third column ">
              <Tabs onSelect={this.handleSelect}>
                <TabList>
                  <Tab className= "textcolor">One Way</Tab>
                  <Tab className= "textcolor">Return</Tab>
                </TabList>
                ...
                <TabPanel>
                  <div className="Form">
                    <form onSubmit={this.handleSubmit}>
                      ...
                      <input className='textcolor' type="submit" value="Search" />
                    </form>
                  </div>
                </TabPanel>
                ...
                <TabPanel>
                  <div className="Form">
                    <form onSubmit={this.handleSubmit}>
                      ...
                      <input className="textcolor row" type="submit" value="Search"  />
                    </form>
                  </div>
                </TabPanel>
              </Tabs>
          ...
          <div className="two-thirds column">
            <div className="header">
                ...
                <div className="Item-right textcolor">
                  "  {startDate}  " : 
                </div>
